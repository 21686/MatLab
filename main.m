...
while 1
    ...
    switch upr
        ...
        case 3
            disp('Открыть файлы лабораторной работы №3');
                    l3_menu = menu('Выберите задание из ЛР3:', T10, T11, T12);
                    switch l3_menu
                        case 1 
                            disp('Равенства');
                            run("eq.m");
